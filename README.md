...
It lets you capture what you need your AI to understand so it has a clear idea what you want it to do, without
...
Here's an example of what you might see if your run this Metaphor prompt:

![A report outline generated by AI](img/report-outline.webp)
